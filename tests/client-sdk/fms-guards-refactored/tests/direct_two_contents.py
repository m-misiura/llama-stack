...
async def test_fms_detectors_live():
    """Test multiple content detectors using direct API calls"""
    ...
    class MockShieldStore:
        async def get_shield(self, shield_id: str) -> Shield:
            return Shield(
                ...
                provider_id="fms",
                provider_resource_id="*",  # Use wildcard to test all detectors
                params={},
            )
    ...
    print("\nRunning Direct API Multi-Detector Tests")
    print("=====================================")
    ...
    try:
        for case in test_cases:
            ...
            if response.violation:
                ...
                required_fields = ["detection_type", "score", "start", "end", "text"]
